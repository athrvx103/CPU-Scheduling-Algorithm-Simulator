...
public class AbsoluteConstraints implements java.io.Serializable {
	 ...
	 * which is used during the deserialization process to verify that the sender and receiver of a serialized object 
	 * are compatible in terms of class structure.
	When a class is serialized, the serialVersionUID is
	written into the serialized object. During deserialization, 
	Java checks whether the serialVersionUID of the class matches
	the serialVersionUID in the serialized object. 
	If they don't match, it throws an InvalidClassException**/
